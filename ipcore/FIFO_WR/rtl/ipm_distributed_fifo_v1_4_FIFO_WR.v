...
//
// Library:
// Filename:ipm_distributed_fifo_v1_4_FIFO_WR.v
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

`timescale 1 ns / 1 ps

module ipm_distributed_fifo_v1_4_FIFO_WR
 #(
...
//instance sdpram
ipm_distributed_sdpram_v1_3_FIFO_WR
#(
 .ADDR_WIDTH(ADDR_WIDTH )  ,    //address width   range:4-10
 .DATA_WIDTH(DATA_WIDTH )  ,    //data width      range:4-256
 .RST_TYPE  (RST_TYPE   )  ,    //reset type   "ASYNC_RESET" "SYNC_RESET"
 .OUT_REG   (OUT_REG    )
 ) ipm_distributed_sdpram_FIFO_WR
 (
  .wr_data  (wr_data    )  ,
  .wr_addr  (wr_addr    )  ,
  .rd_addr  (rd_addr    )  ,
...
ipm_distributed_fifo_ctr_v1_1_FIFO_WR
 #(
...
)u_ipm_distributed_fifo_ctr_FIFO_WR
(
